...
//
// __APP_DEV__ is the ONLY dev/prod switch the app code may use: `import.meta`
// is a parse error in the immediately.run sandbox, where this global is simply
// undefined (= production behaviour).
